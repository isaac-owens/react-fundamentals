...
- IMPERATIVE vs. DECLARATIVE
  - Imperative is concerned with HOW something is accomplished
  - Declarative is concerned with WHAT is to be accomplished
- The most declarative solutions are an abstraction over some imperative
  implementation

- If you haven’t already, I highly recommend getting more familiar with
  functional programming techniques in JavaScript.
- Odds are there isn’t a lower hanging fruit to improve your codebase than
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=iowens%40mediamath.com).
